...
const Share = () => (
  <div>
    <a
      ...
      className='fixed left-10 md:left-1/4 lg:left-1/3 fixed bottom-4 flex items-center justify-between bg-white py-2 px-4 rounded-full border border-black text-black'
    >
      <Image
        alt='GitHub logo'
        height={20}
